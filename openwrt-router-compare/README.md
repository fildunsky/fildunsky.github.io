...
Интерактивная таблица сравнения среднебюджетных роутеров на базе **MediaTek MT7981**
...
[Оригинальный проект](https://hattabbi4.github.io/openwrt-router-compare/) не обновляется.
